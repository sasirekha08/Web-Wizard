    ...
    return (
        <>
            {component?.layout === 'stacked' ? (
                                                ...
                                                selectedTab?.name === tab?.name
                                                    ? `border-l-[4px] ${
                                                          [
                                                              ...
                                                              ? 'border-l-[#3e362e] border-l-[4px]  font-bold'
                                                              : 'border-l-primaryColor font-bold'
                                                      }  font-bold`
                                                    : 'border-l-[2px] font-normal '
                ...
                <div>
                    <div className='  w-full  border-y-[1px] '>
                    ...
                    <div className=' mt-2'>{children(selectedTab)}</div>
                </div>
            )}
        </>
    )
