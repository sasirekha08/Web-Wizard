...
const Padding = ({ updateProperties, selectedComponent, parsePixelValueToNumber }) => {
    const [padding, setPadding] = useState({
        paddingTop: parsePixelValueToNumber(selectedComponent?.style?.paddingTop),
        paddingBottom: parsePixelValueToNumber(selectedComponent?.style?.paddingBottom),
        paddingLeft: parsePixelValueToNumber(selectedComponent?.style?.paddingLeft),
        paddingRight: parsePixelValueToNumber(selectedComponent?.style?.paddingRight),
    })

    const handelPaddingChange = (value, type) => {
        let updatedStyle = { ...selectedComponent.style }

        // Handle padding types
        switch (type) {
            case 'paddingTop':
                updatedStyle = { ...updatedStyle, paddingTop: `${value}px` }
                setPadding({ ...padding, paddingTop: value })
                break
            case 'paddingBottom':
                updatedStyle = { ...updatedStyle, paddingBottom: `${value}px` }
                setPadding({ ...padding, paddingBottom: value })
                break
            case 'paddingLeft':
                updatedStyle = { ...updatedStyle, paddingLeft: `${value}px` }
                setPadding({ ...padding, paddingLeft: value })
                break
            case 'paddingRight':
                updatedStyle = { ...updatedStyle, paddingRight: `${value}px` }
                setPadding({ ...padding, paddingRight: value })
                break
            default:
    ...
    return (
        <div className='flex justify-between items-center'>
            <label className='text-xs text-subItemGray font-medium block  shrink-0'>Padding</label>
                ...
                <div className='flex justify-between gap-2'>
                    <div className='flex items-center bg-[#F2F2F2] rounded p-2 w-[64px] h-[32px]'>
                        <input
                            ...
                            onChange={(e) => handelPaddingChange(e.target.value, 'paddingTop')}
                        />
                        <svg
                            width='8'
                            height='9'
                    ...
                    <div className='flex items-center bg-[#F2F2F2] rounded p-2 w-[64px] h-[32px]'>
                        <input
                            ...
                            onChange={(e) => handelPaddingChange(e.target.value, 'paddingBottom')}
                        />
                        <svg
                            width='7'
                            height='9'
                ...
                <div className='flex justify-between gap-2 mt-2'>
                    <div className='flex items-center bg-[#F2F2F2] rounded p-2 w-[64px] h-[32px]'>
                        <input
                            ...
                            onChange={(e) => handelPaddingChange(e.target.value, 'paddingLeft')}
                        />
                        <svg
                            width='6'
                            height='9'
                    ...
                    <div className='flex items-center bg-[#F2F2F2] rounded p-2 w-[64px] h-[32px]'>
                        <input
                            ...
                            onChange={(e) => handelPaddingChange(e.target.value, 'paddingRight')}
                        />
                        <svg
                            width='7'
                            height='9'
